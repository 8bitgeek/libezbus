...
extern caribou_gpio_t ezbus_dir; 	// RS-485 Direction Control
...
#define GPIO_AF_USART2			GPIO_AF_0
...
#define	CARIBOU_PORTA_MODE		PIN_MODE(0,GPIO_Mode_IN) |		\
								...
								PIN_MODE(2,GPIO_Mode_AF) |		/* EZBUS TX */						\
								PIN_MODE(3,GPIO_Mode_AF) |		/* EZBUS RX */						\
								...
								PIN_MODE(10,GPIO_Mode_OUT) |	/* EZBUS DIR */						\
...
#define	CARIBOU_PORTB_MODE		PIN_MODE(0,GPIO_Mode_IN) |	\
								...
								PIN_MODE(3,GPIO_Mode_IN) |		/* ARDUINO D3 */			\
								PIN_MODE(4,GPIO_Mode_IN) |		/* ARDUINO D5 */			\
								PIN_MODE(5,GPIO_Mode_IN) |	\
								PIN_MODE(6,GPIO_Mode_IN) |	\
								PIN_MODE(7,GPIO_Mode_IN) |	\
								PIN_MODE(8,GPIO_Mode_IN) |	\
								PIN_MODE(9,GPIO_Mode_IN) |	\
								PIN_MODE(10,GPIO_Mode_IN) |	/* ARDUINO D6 */			\
								PIN_MODE(11,GPIO_Mode_IN) | \
								PIN_MODE(12,GPIO_Mode_IN) | \
...
#define	CARIBOU_PORTC_MODE		PIN_MODE(0,GPIO_Mode_IN) |	\
								...
								PIN_MODE(5,GPIO_Mode_IN) |	\
								PIN_MODE(6,GPIO_Mode_IN) |	\
								PIN_MODE(7,GPIO_Mode_IN) |			/* ARDUINO D9 */		\
								PIN_MODE(8,GPIO_Mode_IN) |	\
								PIN_MODE(9,GPIO_Mode_IN) |	\
